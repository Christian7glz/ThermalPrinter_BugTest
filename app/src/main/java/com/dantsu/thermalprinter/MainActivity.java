...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TEST LINES UNDER!!
        //I only modified the method "printUSB" to print "Hola" on the main view
        //On the view "activity_nueva" has to print "Mundo"
        button = (Button) this.findViewById(R.id.btn_changeView);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nextView();
    ...
    {
        Intent changeView = new Intent(this,Nueva.class);
    ...
    public AsyncEscPosPrinter getAsyncEscPosPrinter(DeviceConnection printerConnection) {
        ...
        return printer.setTextToPrint("[C]Hola");
    }
}
